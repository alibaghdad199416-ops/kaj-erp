...
void main() {
  test(
    'OpportunityModel preserves canonical Sales and Maintenance projection',
    () {
  ...
  test('OpportunityModel protects probability display boundary', () {
    OpportunityModel build(num probability) =>
        OpportunityModel.fromMap(<String, Object?>{
          'id': 'opp-$probability',
  ...
  test(
    'Commercial snapshot carries Sales to Opportunity context coherently',
    () {
  ...
  test(
    'R70 Opportunity domain errors are localized instead of exposed raw',
    () {

...
void main() {
  test('unified engine keeps same-key filter values as OR and dimensions as AND', () {
  ...
  test('report customization retains business-facing code and description columns', () {
    ...
    final result = const ContextualReportCustomizer().apply(
      const [section],

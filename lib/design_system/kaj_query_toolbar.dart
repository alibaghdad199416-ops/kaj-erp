...
/// Shared ERP search/filter/sort surface. Modules provide only their own
/// filter and sort menus; active conditions and their removal stay uniform.
...
class _KajQueryToolbarState extends State<KajQueryToolbar> {
  ...
  void didUpdateWidget(covariant KajQueryToolbar oldWidget) {
    ...
    widget.controller.addListener(_sync);
    _setText(widget.controller.state.search);
  }
          ...
          children: [
            ConstrainedBox(
              constraints: BoxConstraints(
                minWidth: widget.compact ? 180 : 220,
                maxWidth: widget.compact ? 300 : 420,
              ),
              child: TextField(
            ...
            children: [
              ...
              ...state.sorts.map(
                (sort) => InputChip(
                  ...
                  avatar: Icon(
                    sort.descending ? Icons.south_rounded : Icons.north_rounded,
                    size: 15,
                  ),

...
abstract final class UnifiedPdfIdentity {
  ...
  static const double pageMarginTop = 26;
  static const double pageMarginBottom = 28;
  static const double tableHeaderFontSize = 8;
  static const double tableCellFontSize = 7.5;
}

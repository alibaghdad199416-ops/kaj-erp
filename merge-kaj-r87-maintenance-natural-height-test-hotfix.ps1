...
$backupRoot = Join-Path $parent "kaj-erp-r87-maintenance-natural-height-test-hotfix-backup-$stamp"
$tempRoot = Join-Path ([System.IO.Path]::GetTempPath()) "kaj-erp-r87-maintenance-natural-height-test-hotfix-$stamp-$PID"
...
try {
  ...
  @(
    'KAJ ERP R87 Maintenance Natural-height Test Hotfix Merge Manifest'
    "Target: $TargetRoot"

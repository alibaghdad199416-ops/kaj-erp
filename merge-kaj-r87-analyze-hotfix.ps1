...
$backupRoot = Join-Path $parent "kaj-erp-r87-analyze-hotfix-backup-$stamp"
$tempRoot = Join-Path ([System.IO.Path]::GetTempPath()) "kaj-erp-r87-analyze-hotfix-$stamp-$PID"
...
try {
  ...
  @(
    'KAJ ERP R87 Analyze Hotfix Merge Manifest'
    "Target: $TargetRoot"

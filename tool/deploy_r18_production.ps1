...
Invoke-Step 'R18 installed-workspace validation and fresh web build' {
    npm run validate:r18:workspace
}
...
Write-Host "`nPASS R18 production deployment" -ForegroundColor Green

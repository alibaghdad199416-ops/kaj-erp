...
Invoke-Step 'R41 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r41_workspace.ps1 }
...
Write-Host "`nPASS R41 production deployment" -ForegroundColor Green

...
$RequiredRemoteMigrations = @(
  ...
  '20260809122052','20260809124736','20260809125507','20260809161514'
)
...
Invoke-Step 'R40 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r40_workspace.ps1 }
...
Write-Host "`nPASS R40 production deployment" -ForegroundColor Green

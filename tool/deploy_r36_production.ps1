...
$RequiredRemoteMigrations = @(
  ...
  '20260809122052'  # R36 runtime/UI/opportunity/maintenance closure
)
...
Invoke-Step 'R36 installed-workspace validation and fresh web build' {
  powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r36_workspace.ps1
}
...
Write-Host "`nPASS R36 production deployment" -ForegroundColor Green

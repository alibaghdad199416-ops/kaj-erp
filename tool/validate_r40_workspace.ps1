...
Invoke-Step 'R40 gates' { npm run verify:r40 }
Invoke-Step 'R39 compatibility' { npm run verify:r39 }
...
Write-Host "`nPASS R40 installed-workspace validation" -ForegroundColor Green

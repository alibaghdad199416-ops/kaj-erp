...
r90=t('supabase/migrations/20260820113000_r90_phase11_final_acceptance_closure.sql')

need('R41 retained', 'verify:r41' in pkg)
need('cashbox list uses R42 canonical endpoint or secured R90 facade', (("'erp_r42_list_cash_accounts'" in repo) or ("'erp_r90_list_cash_accounts'" in repo and 'from public.erp_r42_list_cash_accounts' in r90)) and "'erp_r28_list_cash_accounts'" not in repo)
need('cashbox save uses R42 canonical endpoint or guarded R90 facade', (("'erp_r42_save_cash_account'" in repo) or ("'erp_r90_save_cash_account'" in repo and 'return public.erp_r42_save_cash_account' in r90)) and "'erp_r28_save_cash_account'" not in repo)

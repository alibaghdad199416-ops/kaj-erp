...
Invoke-Step 'R37 gates' { npm run verify:r37 }
Invoke-Step 'R36 compatibility' { npm run verify:r36 }
...
Write-Host "`nPASS R37 installed-workspace validation" -ForegroundColor Green

...
$RequiredRemoteMigrations = @(
  ...
  '20260809122052','20260809124736','20260809125507'
)
...
Invoke-Step 'R37 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r37_workspace.ps1 }
...
Write-Host "`nPASS R37 production deployment" -ForegroundColor Green

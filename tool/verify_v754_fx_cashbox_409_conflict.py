...
assert ("erp_transfer_cloud_cash_v4" in r and "erp_transfer_cloud_cash_v3" not in r) or "erp_v2300_transfer_cloud_cash" in r or ("erp_r9_transfer_cloud_cash" in r and "erp_v2300_transfer_cloud_cash" in r9) or ("erp_r22_transfer_cloud_cash" in r and "erp_v762_assert_posted_journal_balanced" in r22 and "cashTransactionId" in r22)

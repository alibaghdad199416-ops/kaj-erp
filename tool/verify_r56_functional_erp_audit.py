...
# Reject common placeholders, debug-only exits, and empty business methods.
for p in (ROOT / 'lib').rglob('*.dart'):
    ...
    assert not re.search(r'\bdebugPrint\s*\(\s*[\'\"]TODO', text), f'debug placeholder: {p.relative_to(ROOT)}'

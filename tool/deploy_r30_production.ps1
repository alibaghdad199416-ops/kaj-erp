...
Invoke-Step 'R30 installed-workspace validation and fresh web build' {
  powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r30_workspace.ps1
}
...
Write-Host "`nPASS R30 production deployment" -ForegroundColor Green

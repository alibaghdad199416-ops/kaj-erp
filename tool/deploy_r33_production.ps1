...
Invoke-Step 'R33 installed-workspace validation and fresh web build' {
  powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r33_workspace.ps1
}
...
Write-Host "`nPASS R33 production deployment" -ForegroundColor Green

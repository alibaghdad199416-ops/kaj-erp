...
Invoke-Step 'R39 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r39_workspace.ps1 }
...
Write-Host "`nPASS R39 production deployment" -ForegroundColor Green

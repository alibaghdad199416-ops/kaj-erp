...
Invoke-Step 'R44 gates' { npm run verify:r44 }
Invoke-Step 'R43 compatibility' { npm run verify:r43 }
...
Write-Host "`nPASS R44 installed-workspace validation" -ForegroundColor Green

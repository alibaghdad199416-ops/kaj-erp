...
need('browser PDF canonical English', "canonicalPdfLanguage" in pdf and "kIsWeb ? 'en'" in pdf and 'canonicalPdfArabic' in pdf)
need('native Arabic never falls back to Latin-only font', 'rethrow;' in pdf and 'corrupted Arabic glyphs' in pdf)
...
need('true browser print retained', 'frameWindow.print()' in pdfweb or ('html.Blob' in pdfweb and "html.window.open(url, '_blank')" in pdfweb))

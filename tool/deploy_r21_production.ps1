...
Invoke-Step 'R21 installed-workspace validation and fresh web build' {
    npm run validate:r21:workspace
}
...
Write-Host "`nPASS R21 production deployment" -ForegroundColor Green

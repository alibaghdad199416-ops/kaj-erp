...
Invoke-Step 'R43 gates' { npm run verify:r43 }
Invoke-Step 'R42 compatibility' { npm run verify:r42 }
...
Write-Host "`nPASS R43 installed-workspace validation" -ForegroundColor Green

...
need('lib/core/release/app_release_info.dart', '22.9.8-final-cross-stage-integrity-r57-r58-r59-r60')
need('web/version.json', '"releaseToken": "final-cross-stage-integrity-20260826"')
need('web/version.json', '"channel": "final"')
need('web/version.json', '22.9.8-final-cross-stage-integrity-r57-r58-r59-r60')

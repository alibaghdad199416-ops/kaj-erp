...
$RequiredRemoteMigrations = @(
  ...
  '20260809122052','20260809124736','20260809125507','20260809161514','20260809170859'
)
...
Invoke-Step 'R42 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r42_workspace.ps1 }
...
Write-Host "`nPASS R42 production deployment" -ForegroundColor Green

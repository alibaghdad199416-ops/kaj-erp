...
Invoke-Step 'R38 installed-workspace validation and fresh web build' { powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r38_workspace.ps1 }
...
Write-Host "`nPASS R38 production deployment" -ForegroundColor Green

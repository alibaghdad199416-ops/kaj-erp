...
checks["web PDF download service"]="html.Blob" in pdfweb and "AnchorElement" in pdfweb and "..download = safeFileName" in pdfweb and "html.window.open(" not in pdfweb

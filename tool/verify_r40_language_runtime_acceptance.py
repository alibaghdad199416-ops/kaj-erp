...
checks["web PDF download service"]="browser_download.saveBinary" in pdfweb and "html.Blob" in binaryweb and "AnchorElement" in binaryweb and "..download = fileName" in binaryweb and "html.window.open(" not in pdfweb

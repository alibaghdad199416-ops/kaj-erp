...
Invoke-Step 'R34 installed-workspace validation and fresh web build' {
  powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r34_workspace.ps1
}
...
Write-Host "`nPASS R34 production deployment" -ForegroundColor Green

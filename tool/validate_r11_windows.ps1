...
try {
    ...
    # verify:all includes database/source/localization, R8/R9/R10/R11, package and deployment gates.
    ...
    Write-Host "`nPASS R11 Windows release validation" -ForegroundColor Green

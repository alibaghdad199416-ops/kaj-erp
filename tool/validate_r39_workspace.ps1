...
Invoke-Step 'R39 gates' { npm run verify:r39 }
Invoke-Step 'R38 compatibility' { npm run verify:r38 }
...
Write-Host "`nPASS R39 installed-workspace validation" -ForegroundColor Green

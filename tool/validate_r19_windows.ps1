...
Invoke-Step 'R19 installed-workspace release validation' { npm run validate:r19:workspace }
Write-Host "`nPASS R19 Windows release validation" -ForegroundColor Green

...
need('web pdf blob download path', 'html.Blob' in pdf_web and 'html.AnchorElement' in pdf_web and '..download = safeFileName' in pdf_web and 'html.window.open(' not in pdf_web)

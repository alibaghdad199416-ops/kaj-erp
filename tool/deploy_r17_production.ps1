...
Invoke-Step 'R17 installed-workspace validation and fresh web build' {
    npm run validate:r17:workspace
}
...
Write-Host "`nPASS R17 production deployment" -ForegroundColor Green

...
Invoke-Step 'R32 installed-workspace validation and fresh web build' {
  powershell -NoProfile -ExecutionPolicy Bypass -File tool/validate_r32_workspace.ps1
}
...
Write-Host "`nPASS R32 production deployment" -ForegroundColor Green

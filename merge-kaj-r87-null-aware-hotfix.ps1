...
$backupRoot = Join-Path $parent "kaj-erp-r87-null-aware-hotfix-backup-$stamp"
$tempRoot = Join-Path ([System.IO.Path]::GetTempPath()) "kaj-erp-r87-null-aware-hotfix-$stamp-$PID"
...
try {
  ...
  @(
    'KAJ ERP R87 Null-aware Syntax Hotfix Merge Manifest'
    "Target: $TargetRoot"

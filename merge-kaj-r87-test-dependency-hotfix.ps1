...
$backupRoot = Join-Path $parent "kaj-erp-r87-test-dependency-hotfix-backup-$stamp"
$tempRoot = Join-Path ([System.IO.Path]::GetTempPath()) "kaj-erp-r87-test-dependency-hotfix-$stamp-$PID"
...
try {
  ...
  @(
    'KAJ ERP R87 Test Dependency Hotfix Merge Manifest'
    "Target: $TargetRoot"

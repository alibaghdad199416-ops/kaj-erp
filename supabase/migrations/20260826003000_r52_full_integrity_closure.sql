...
-- R52 consolidated integrity closure. Additive and data-preserving. The accepted-module cleanup intentionally retires erp_contracts before this migration. Do not use a retired table as a CREATE TABLE LIKE template.

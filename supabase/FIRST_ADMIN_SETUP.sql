-- Run once in Supabase SQL Editor after creating the first Auth user.
-- Replace the three values below before execution.
-- This file contains no password and no secret/service-role key.

do $$
declare
  v_user_id uuid := '00000000-0000-0000-0000-000000000000'; -- Auth user UUID
  v_email text := 'owner@example.com';                        -- Auth user email
